...
<?php
    ...
    $query      =   "SELECT nome,problema,setor,data_atual,ticketID FROM ticktes WHERE usuarioID = $usuarioId";
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card" style="margin-top: 5%; padding:5%;">
                                        ...
                                        <p><?=$linha['problema']?></p>
                                        <a href="../editar_tickets.php/?codigo=<?php echo $linha['ticketID']?>" class="btn btn-success" >Editar ticket</a>
                                    </div>
                                </div>
                                <?php
